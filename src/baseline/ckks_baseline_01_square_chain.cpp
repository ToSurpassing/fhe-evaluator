...
void RunOneMode(const std::string& modeName, ScalingTechnique scalTech) {
    std::cout << "\n============================================================\n";
    std::cout << "[BASELINE] eager square chain\n";
    ...
    std::cout << "\nsummary:\n";
    std::cout << "  eager chain total time = " << std::scientific << totalTime << " s\n";
    std::cout << "  final level            = " << ct_sq->GetLevel() << '\n';
    std::cout << "  final noiseScaleDeg    = " << ct_sq->GetNoiseScaleDeg() << '\n';
}
